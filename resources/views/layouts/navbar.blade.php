<nav class="fixed top-0 left-0 w-full bg-white/80 backdrop-blur-lg shadow-md text-black p-4 flex justify-between items-center">
    <!-- Logo -->
    ...
    <ul class="hidden md:flex space-x-6">
        <li><a href="index.html" class="text-orange-500">Home</a></li>
        ...
        <li><a href="about.html" class="hover:text-orange-500">Overview</a></li>
